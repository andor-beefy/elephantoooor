...
contract UniswapSwapv3 {
    ...
    function swapExactInputSingle(uint256 _amountIn, address _tokenInAddress, address _tokenOutAddress, uint _amountOutMinimum) external returns (uint256 amountOut) {
        // Transfer the specified amount of tokenInAddress to this contract.
        TransferHelper.safeTransferFrom(_tokenInAddress, msg.sender, address(this), _amountIn);
